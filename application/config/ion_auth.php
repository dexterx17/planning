 ...
 */
$config['site_title']                 = "planning.santanagrafico.com";       // Site Title, example.com
$config['admin_email']                = "admin@santanagrafico.com"; // Admin Email, admin@example.com
 ...
 */
$config['remember_cookie_name'] = 'recordando_code';
$config['identity_cookie_name'] = 'identidad';
...
$config['message_start_delimiter'] = '<p class="alert alert-info alert-dismissable">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p class="alert alert-danger alert-dismissable">';		// Error message start delimiter

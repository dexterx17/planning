...
class Auth extends CI_Controller {
	...
	/**
	 * Despliega el formulario de Inicio de sesión y lo válida
	 **/
	function login()
	{
	...
	/**
	 * Cierra la sesión de usuario y redirecciona a la página de login
	 **/
	function logout()
	{
	...
	/**
	 * Despliega un formulario para crear y registrar 
	 * un nuevo usuario,
	 * Captura y válida los datos del formulario
	 **/
	function create_user()
	{
		$this->data['title'] = $this->lang->line('create_user_title');
